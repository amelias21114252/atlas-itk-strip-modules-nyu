...
print(f"\n🚩 Category B input noise errors mean > {NOISE_THRESHOLD}: {len(category_B_errors)}")
for err in category_B_errors:
    print(
        f"{err['serial']} | {err['file']} | mean = {err['mean']}"
    )

if not category_B_errors:
    print("None")
